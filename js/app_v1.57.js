...
const app = {
    ...
    loadLocalData: () => {
        const stored = localStorage.getItem('starAcademyPOS_v157') || localStorage.getItem('starAcademyPOS_v156');
        if (stored) {
    ...
    saveData: () => { 
        localStorage.setItem('starAcademyPOS_v157', JSON.stringify(app.data));
    ...
    downloadFullBackup: () => {
        ...
        a.download = "StarAcademy_Backup_v1.57.json";
        a.click();
    },
