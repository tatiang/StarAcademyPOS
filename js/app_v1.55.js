...
const app = {
    ...
    loadLocalData: () => {
        const stored = localStorage.getItem('starAcademyPOS_v155') || localStorage.getItem('starAcademyPOS_v154');
        if (stored) {
    ...
    saveData: () => { 
        localStorage.setItem('starAcademyPOS_v155', JSON.stringify(app.data));
    ...
    // --- IT TOOLS ---
    fetchTestingNotes: () => {
        // v1.55 Change: Look for TESTING_NOTES.md specifically
    ...
    downloadFullBackup: () => {
        ...
        a.download = "StarAcademy_Backup_v1.55.json";
        a.click();
    },
    ...
    renderManagerHub: () => {
        ...
        // Product rendering for manager logic here if needed
    },
