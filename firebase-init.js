    ...
    if (!unsubscribe) {
        ...
        const safetyTimeout = setTimeout(() => {
            ...
            if(loadMsg && loadMsg.style.display !== 'none') {
                ...
                document.getElementById('student-login-grid').classList.remove('hidden');
                document.getElementById('admin-divider').classList.remove('hidden');
                document.getElementById('admin-login-buttons').classList.remove('hidden');
                // Ensure app has loaded local data first
